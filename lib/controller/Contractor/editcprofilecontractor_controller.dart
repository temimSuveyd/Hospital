...
abstract class EditcprofilecontractorController extends GetxController {
updateProfile();
getUserData();
gotomap();
getSharedData();
...
class EditcprofilecontractorControllerImp
    extends EditcprofilecontractorController {
