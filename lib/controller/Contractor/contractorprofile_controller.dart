...
abstract class ContractorprofileController extends GetxController {
  gotoeditprofile();
  deleteAccount();
  getUserData();
  getSharedData();
...
class ContractorprofileControllerImp extends ContractorprofileController {
...
// user data
  ...
  @override
  gotoeditprofile() {
    Get.toNamed(Approutes.contractorEditProfile);
  }
