...
class Customnavigatorbottombaradmin extends StatelessWidget {
  const Customnavigatorbottombaradmin ({super.key});

  @override
  Widget build(BuildContext context) {
    HomescreenadminControllerImp controller = Get.put(HomescreenadminControllerImp());
    // final SettingsController controllersett = Get.put(SettingsController());

    return GetBuilder<HomescreenadminControllerImp>(
